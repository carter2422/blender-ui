...
bool uiPanelIsPin(Panel *panel)
{
	return (panel->flag & PNL_PIN) != 0;
}

Panel *uiPanelFind(ARegion *ar, PanelType *pt)
{
	Panel *pa;
...
void UI_panel_category_draw_all(ARegion *ar, const char *category_id_active)
{
	...
	text_v_ofs = (rct_xmax - rct_xmin) * 0.3f;
